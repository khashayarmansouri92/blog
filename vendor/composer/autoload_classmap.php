...
return array(
    'Application\\Console\\Kernel' => $baseDir . '/src/Application/Console/Kernel.php',
    ...
    'Core\\Exceptions\\Handler' => $baseDir . '/src/Core/Exceptions/Handler.php',
    'Core\\Http\\Controllers\\Controller' => $baseDir . '/src/Core/Http/Controllers/Controller.php',
    'Core\\Http\\Controllers\\User\\UserLoginAction' => $baseDir . '/src/Core/Http/Controllers/User/UserLoginAction.php',
    'Core\\Http\\Controllers\\User\\UserRegisterAction' => $baseDir . '/src/Core/Http/Controllers/User/UserRegisterAction.php',
    'Core\\Http\\Kernel' => $baseDir . '/src/Core/Http/Kernel.php',
    'Core\\Http\\Middleware\\Authenticate' => $baseDir . '/src/Core/Http/Middleware/Authenticate.php',
    'Core\\Http\\Middleware\\EncryptCookies' => $baseDir . '/src/Core/Http/Middleware/EncryptCookies.php',
    'Core\\Http\\Middleware\\PreventRequestsDuringMaintenance' => $baseDir . '/src/Core/Http/Middleware/PreventRequestsDuringMaintenance.php',
    'Core\\Http\\Middleware\\RedirectIfAuthenticated' => $baseDir . '/src/Core/Http/Middleware/RedirectIfAuthenticated.php',
    'Core\\Http\\Middleware\\TrimStrings' => $baseDir . '/src/Core/Http/Middleware/TrimStrings.php',
    'Core\\Http\\Middleware\\TrustHosts' => $baseDir . '/src/Core/Http/Middleware/TrustHosts.php',
    'Core\\Http\\Middleware\\TrustProxies' => $baseDir . '/src/Core/Http/Middleware/TrustProxies.php',
    'Core\\Http\\Middleware\\VerifyCsrfToken' => $baseDir . '/src/Core/Http/Middleware/VerifyCsrfToken.php',
    'Core\\Http\\Requests\\UserLoginRequest' => $baseDir . '/src/Core/Http/Requests/UserLoginRequest.php',
    'Core\\Http\\Requests\\UserRegisterRequest' => $baseDir . '/src/Core/Http/Requests/UserRegisterRequest.php',
    'Core\\Http\\Services\\User\\UserService' => $baseDir . '/src/Core/Http/Services/User/UserService.php',
    'Core\\Http\\Services\\User\\UserServiceInterface' => $baseDir . '/src/Core/Http/Services/User/UserServiceInterface.php',
    'Core\\Http\\Traits\\User\\InteractsWithUser' => $baseDir . '/src/Core/Http/Traits/User/InteractsWithUser.php',
    'Core\\Providers\\AppServiceProvider' => $baseDir . '/src/Core/Providers/AppServiceProvider.php',
    'Core\\Providers\\AuthServiceProvider' => $baseDir . '/src/Core/Providers/AuthServiceProvider.php',
    'Core\\Providers\\BroadcastServiceProvider' => $baseDir . '/src/Core/Providers/BroadcastServiceProvider.php',
    'Core\\Providers\\EventServiceProvider' => $baseDir . '/src/Core/Providers/EventServiceProvider.php',
    'Core\\Providers\\RepositoriesArticleServiceProvider' => $baseDir . '/src/Core/Providers/RepositoriesArticleServiceProvider.php',
    'Core\\Providers\\RouteServiceProvider' => $baseDir . '/src/Core/Providers/RouteServiceProvider.php',
    'Core\\Providers\\UserServiceProvider' => $baseDir . '/src/Core/Providers/UserServiceProvider.php',
    ...
    'Domain\\Model\\User\\User' => $baseDir . '/src/Domain/Model/User/User.php',
    'Domain\\Repositories\\BaseRepository' => $baseDir . '/src/Domain/Repositories/BaseRepository.php',
    'Domain\\Repositories\\User\\UserRepository' => $baseDir . '/src/Domain/Repositories/User/UserRepository.php',
    'Domain\\Repositories\\User\\UserRepositoryInterface' => $baseDir . '/src/Domain/Repositories/User/UserRepositoryInterface.php',
